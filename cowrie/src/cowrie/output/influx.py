...
class Output(cowrie.core.output.Output):
    ...
    def start(self):
        ...
        try:
            ...
            log.msg("output_influx: I/O error({0}): '{1}'".format(e.errno, e.strerror))
            return
        ...
        if CowrieConfig().has_option('output_influx', 'retention_policy_duration'):
            retention_policy_duration = CowrieConfig().get('output_influx', 'retention_policy_duration')
        ...
        if dbname not in dblist:
            ...
            self.client.create_retention_policy(
                retention_policy_name, retention_policy_duration, 1, database=dbname, default=True
            )
        else:
