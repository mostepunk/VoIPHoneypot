...
Download a file via FTP
    ...
    def start(self):
        ...
        self.artifactFile.session = self.protocol.terminal.transport.transportId
        ...
        if not result:
            # log to cowrie.log
            log.msg(format='Attempt to download file(s) from URL (%(url)s) failed', url=self.url_log)
