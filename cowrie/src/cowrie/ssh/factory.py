...
class CowrieSSHFactory(factory.SSHFactory, object):
    ...
    ourVersionString = CowrieConfig().get('ssh', 'version', fallback='SSH-2.0-OpenSSH_6.0p1 Debian-4+deb7u2')
    ...
    def buildProtocol(self, addr):
        ...
        try:
            ...
            t.supportedMACs = [b'hmac-sha2-512', b'hmac-sha2-384', b'hmac-sha2-256', b'hmac-sha1', b'hmac-md5']
