...
version = "{major}.{minor}".format(major=cowrie_version_object.major, minor=cowrie_version_object.minor)
...
texinfo_documents = [
    (
        master_doc, 'cowrie', 'cowrie Documentation', author, 'cowrie', 'One line description of project.',
        'Miscellaneous'
    ),
]
